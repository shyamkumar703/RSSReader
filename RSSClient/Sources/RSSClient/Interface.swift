...
public struct RSSClient {
    ...
    public var feedFor: (Int?, Int, FeedFilter, String) -> AnyPublisher<FeedResponse, Error>
    // Fire and forget
    /// entryIds, status
    ...
    public init(
        ...
        feedFor: @escaping (Int?, Int, FeedFilter, String) -> AnyPublisher<FeedResponse, Error>,
